...
export const MovieInfo = ({ movie }: { movie: Movie }) => (
  <div className='absolute z-10 w-full rounded-b-md bg-zinc-800 p-2 shadow-md transition-colors lg:p-4'>
    <div className='flex flex-row items-center justify-between gap-2'>
      <div className='flex flex-row items-center gap-2'>
        <div className='flex h-6 w-6 cursor-pointer items-center justify-center rounded-full hover:bg-neutral-300 hover:text-black transition-colors lg:h-10 lg:w-10 text-white'>
