      ...
      <main className='relative pb-24 pl-4 lg:space-y-24 lg:pl-16'>
        <div className='flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
          ...
          <p className='max-w-xs text-xs text-shadow-md md:max-w-lg md:text-lg lg:max-w-2xl'>
            Em visita à ONU em Nova York, um ditador acaba sequestrado e
            barbeado. Sem seu visual característico, ele assiste ao tio traidor
            assumir o poder, mas, com a ajuda de uma feminista vegetariana do
            Brooklyn, tentará reconquistar seu trono.
          </p>
        </div>
